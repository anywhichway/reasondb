...
(function () {
	module.exports = function (ReasonDB) {
		var IronCacheStore = function (_ReasonDB$Store) {
			(0, _inherits3.default)(IronCacheStore, _ReasonDB$Store);

			function IronCacheStore(name, keyProperty, db, clear) {
				(0, _classCallCheck3.default)(this, IronCacheStore);

				var _this = (0, _possibleConstructorReturn3.default)(this, (IronCacheStore.__proto__ || (0, _getPrototypeOf2.default)(IronCacheStore)).call(this, name, keyProperty, db));
						...
						return _regenerator2.default.wrap(function _callee2$(_context2) {
							while (1) {
								switch (_context2.prev = _context2.next) {
									case 0:
										me = this;
										return _context2.abrupt("return", (0, _get3.default)(IronCacheStore.prototype.__proto__ || (0, _getPrototypeOf2.default)(IronCacheStore.prototype), "delete", this).call(this, key, function () {
						...
						return _regenerator2.default.wrap(function _callee3$(_context3) {
							while (1) {
								switch (_context3.prev = _context3.next) {
									case 0:
										me = this;
										return _context3.abrupt("return", (0, _get3.default)(IronCacheStore.prototype.__proto__ || (0, _getPrototypeOf2.default)(IronCacheStore.prototype), "get", this).call(this, key, function () {
											return new _promise2.default(function (resolve, reject) {
						...
						return _regenerator2.default.wrap(function _callee4$(_context4) {
							while (1) {
								switch (_context4.prev = _context4.next) {
									case 0:
										me = this;
										return _context4.abrupt("return", (0, _get3.default)(IronCacheStore.prototype.__proto__ || (0, _getPrototypeOf2.default)(IronCacheStore.prototype), "set", this).call(this, key, value, normalize, function (normalized) {
											return new _promise2.default(function (resolve, reject) {
